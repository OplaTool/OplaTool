...
public class OPLA extends Problem {
	...
	for (int i = 0; i < this.selectedMetrics.size(); i++) {
	    ...
	    switch (metric) {
	    case "elegance":
	    jmetal.experiments.Fitness e= new jmetal.experiments.Fitness(evaluateElegance((Architecture) solution.getDecisionVariables()[0]));
	    fitnesses.add(e);
	    System.out.println ("valor do elegance: " + e.getValue());
	    break;
	    
	    case "conventional":
	    jmetal.experiments.Fitness c = new jmetal.experiments.Fitness(evaluateMACFitness((Architecture) solution.getDecisionVariables()[0]));
	    fitnesses.add(c);
	    System.out.println ("valor do conventional: " + c.getValue());
	    break;
	    
	    case "featureDriven":
		    jmetal.experiments.Fitness f = new jmetal.experiments.Fitness(evaluateMSIFitness((Architecture) solution.getDecisionVariables()[0]));
		    fitnesses.add(f);
		    System.out.println ("valor do featureDriven: " + f.getValue());
		    break;
		    
	    case "PLAExtensibility":
		    jmetal.experiments.Fitness p = new jmetal.experiments.Fitness(evaluatePLAExtensibility((Architecture) solution.getDecisionVariables()[0]));
		    fitnesses.add(p);
		    System.out.println ("valor do PLAExtensibility: " + p.getValue());
		    break;
		    
	    case "acomp":
		    jmetal.experiments.Fitness a = new jmetal.experiments.Fitness(evaluateACOMP((Architecture) solution.getDecisionVariables()[0]));
		    fitnesses.add(a);
		    System.out.println ("valor do acomp: " + a.getValue());
		    break;
		    
	    case "aclass":
		    jmetal.experiments.Fitness ac = new jmetal.experiments.Fitness(evaluateACLASS((Architecture) solution.getDecisionVariables()[0]));
		    fitnesses.add(ac);
		    System.out.println ("valor do aclass: " + ac.getValue());
		    break;
		    
	    case "tam":
		    jmetal.experiments.Fitness t = new jmetal.experiments.Fitness(evaluateTAM((Architecture) solution.getDecisionVariables()[0]));
		    fitnesses.add(t);
		    System.out.println ("valor do tam: " + t.getValue());
		    break;
		    
	    case "coe":
		    jmetal.experiments.Fitness co = new jmetal.experiments.Fitness(evaluateCOE((Architecture) solution.getDecisionVariables()[0]));
		    fitnesses.add(co);
		    System.out.println ("valor do coe: " + co.getValue());
		    break;
		    
	    case "h":
		    jmetal.experiments.Fitness h = new jmetal.experiments.Fitness(evaluateH((Architecture) solution.getDecisionVariables()[0]));
		    fitnesses.add(h);
		    System.out.println ("valor do coe: " + h.getValue());
		    break;
		    
	    case "dc":
		    jmetal.experiments.Fitness dc = new jmetal.experiments.Fitness(evaluateDC((Architecture) solution.getDecisionVariables()[0]));
		    fitnesses.add(dc);
		    System.out.println ("valor do dc: " + dc.getValue());
		    break;
		    
	    case "ec":
		    jmetal.experiments.Fitness ec = new jmetal.experiments.Fitness(evaluateEC((Architecture) solution.getDecisionVariables()[0]));
		    fitnesses.add(ec);
    ...
    public double evaluateH(Architecture architecture) {
    	double coeFitness = 0.0;
    	
    	RelationalCohesion rc = new RelationalCohesion(architecture);
    	
    	coeFitness = rc.getResults();
    	return coeFitness;
    }
