...
//                this.config.getConfig().getDirectoryToExportModels()).size();
  ...
  @SuppressWarnings("unchecked")
    ...
    private void initComponents() {
        ...
        checkH.setText("Relational Cohesion");
        checkH.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                checkHActionPerformed(evt);
            }
        });
  ...
  private String dirChooser(JTextField field) throws HeadlessException {
    ...
    private void checkHActionPerformed (java.awt.event.ActionEvent evt) {//GEN-FIRST:event_checkCoeActionPerformed
        final String metric = Metrics.H.getName();
        addToMetrics(checkH, metric);
    }//GEN-LAST:event_checkCoeActionPerformed
